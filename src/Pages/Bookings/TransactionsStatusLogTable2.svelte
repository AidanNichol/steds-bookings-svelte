        ...
        {#if expSz > 0}
          <g class:historic={_.every(expenditure, 'historic')}>
            <DayHeader
              ...
              title={`${walkId} ${venue}`}
            />
            {#each expenditure as { walkId, status, name, createdAt, Allocations: allocs, owing, memberId, y, y1, y2, y3, sz, log2, maxX, refundId, req, amount }, i}
              <g
                class="expenditure"
