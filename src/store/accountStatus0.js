...
//   set(firstBooking);
// });
const startDate = writable('0000-00-00');
const bStale = writable(true);
const pStale = writable(true);
const loadingBookings = writable(false);
const loadingPayments = writable(false);
...
const nextBookingState = writable(null);
...
const nextPaymentState = writable(null);
const activePayments = derived(
